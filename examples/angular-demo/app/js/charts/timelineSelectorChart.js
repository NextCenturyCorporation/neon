...
charts.TimelineSelectorChart = function (element, configuration)
{
	...
	this.configure = function(configuration)
	{
		...
		this.config.margin = this.config.margin || {top: 0, right: 0, bottom: 20, left: 0};
		this.config.margin2 = this.config.margin2 || {top: 0, right: 0, bottom: 0, left: 0};
  ...
  //           .remove();
		...
		var brush = d3.svg.brush()
		    .x(x)
		    .on("brush", brushed);
		 //   .on("mouseup", function() { console.log("LET GO!"); });
