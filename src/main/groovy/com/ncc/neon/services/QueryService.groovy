...
import com.ncc.neon.query.FilterEvent
...
public class QueryService {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    @Path("addfilter")
    public FilterEvent addFilter(Filter filter) {
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    @Produces(MediaType.APPLICATION_JSON)
    public FilterEvent replaceFilter(@PathParam("id") String replaceId, Filter replaceWith) {
    ...
    private static def wrapInDataJson(json) {
        return '{"data":' + json + '}'
    }
}
