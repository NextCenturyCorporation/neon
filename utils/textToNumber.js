	...
	collection.find().toArray(function(err, items) {
		...
		async.each(items, function(doc, docCallback) {
			if(doc["dig|snapshot"]["dig|primaryLocation"]["schema|geo"]) {
				...
				doc["dig|snapshot"]["dig|primaryLocation"]["schema|geo"]["schema|latitude"] = parseFloat(doc["dig|snapshot"]["dig|primaryLocation"]["schema|geo"]["schema|latitude"]);
				doc["dig|snapshot"]["dig|primaryLocation"]["schema|geo"]["schema|longitude"] = parseFloat(doc["dig|snapshot"]["dig|primaryLocation"]["schema|geo"]["schema|longitude"]);
