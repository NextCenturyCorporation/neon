...
declare module neon {
    ...
    export namespace query {
        ...
        export class Filter {
            ...
            geoIntersection(locationField: string, points: util.LatLon[], geometryType: string): this;
            geoWithin(locationField: string, points: util.LatLon): this;
        ...
        export class WithinDistanceClause {
            ...
            constructor(locationField: string, center: util.LatLon, distance: number, distanceUnit: string);
        }
        ...
        export class intersectionClause {
            ...
            points: util.LatLon[];
            geometryType: string
            constructor(type: string, locationField: string, points: util.LatLon[], geometryType: string);
        }
        ...
        export class withinClause {
            ...
            constructor(locationField: string, points: util.LatLon[]);
        }
        ...
        export function and(...clauses: WherePredicate[]): query.BooleanClause;
        export function or(...clauses: WherePredicate[]): query.BooleanClause;
    ...
    export namespace util {
        ...
        export namespace ajaxUtils {
            function doDelete(url: string, opts: any): util.AjaxRequest;
            function doGet(url: string, opts: any): util.AjaxRequest;
            function doPost(url: string, opts: any): util.AjaxRequest;
            ...
            function doPostJSON(object: any, url: string, opts: any): util.AjaxRequest;
        ...
        export namespace infoUtils {
            export function getNeonVersion(successCallback: (resp: any) => any): util.AjaxRequest;
        }
    ...
    export namespace widget {
        export function getInstanceId(qualifier: string, successCallback: (resp: any) => any): util.AjaxRequest;
        export function getSavedState(id: string, successCallback: (resp: any) => any): util.AjaxRequest;
