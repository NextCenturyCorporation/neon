...
class IllegalArgumentExceptionMapper implements ExceptionMapper<IllegalArgumentException> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(IllegalArgumentExceptionMapper)

    @Override
    public Response toResponse(IllegalArgumentException exception) {
        LOGGER.error(exception.message, exception)
        ExceptionMapperResponse response = new ExceptionMapperResponse("Illegal Argument", exception)
