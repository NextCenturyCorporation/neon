 ...
 */
class ElasticSearch2ConversionStrategyHelper {
    ...
    public static QueryBuilder convertWhereClauses(whereClauses) {
        ...
        def inners = whereClauses.collect(ElasticSearch2ConversionStrategyHelper.&convertWhereClause) as QueryBuilder[]
    ...
    private static QueryBuilder convertWhereClause(clause) {
        switch (clause.getClass()) {
            case AndWhereClause:
                return convertBooleanWhereClause(clause, QueryBuilders.&andQuery)
            case OrWhereClause:
                return convertBooleanWhereClause(clause, QueryBuilders.&orQuery)
    ...
    private static QueryBuilder convertBooleanWhereClause(clause, Closure<QueryBuilder> combiner) {
        def inners = clause.whereClauses.collect(ElasticSearch2ConversionStrategyHelper.&convertWhereClause)
