...
import com.ncc.neon.query.transform.bucketing.Bucket
import com.ncc.neon.query.transform.bucketing.BucketingSystem
    ...
    QueryResult convert(QueryResult queryResult, def params) {
        ...
        if (params.loadNew || bucketor == null) {
            if (queryResult != null && queryResult.getData() != null) {
                ...
                List toReturn = [emptyData, emptyData]
        ...
        for(; i < buckets.length; i++) {
            ...
            b.data << [count: buckets[i].getCount(),
        ...
        List toReturn = [emptyData, [data: newData]]
        return new TabularQueryResult(toReturn)
    }
