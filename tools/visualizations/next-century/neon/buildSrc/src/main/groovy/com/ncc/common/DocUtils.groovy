...
/**
 * Utilities for zipping and copying documentation
 */
class DocUtils {
     ...
     * @param buildDir
     */
    static def doZipDocs(copyDocsTask, zipTask, buildDir) {
     ...
     */
    static def doCopyDocsIntoZipDir(classifier, libraryName, copyTask, docDir) {
